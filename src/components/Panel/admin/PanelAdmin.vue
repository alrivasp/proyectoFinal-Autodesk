<template>
  <div>
    ...
    >
      ...
      <div class="w-100 titleCompany" v-show="this.cuentas">CUENTAS</div>
    ...
    <b-sidebar id="sidebar-1" shadow>
      ...
      <div class="itemView" @click="viewComponent('cuentas')">
        <span class="itemArea"
          ><font-awesome-icon class="" icon="fa-user-circle" /> CUENTAS</span
        >
      </div>
      <!-- FOOTER START-->
      <footer class="fixed-bottom bg-primary footer">
        ...
        <div class="itemFooter">
          <font-awesome-icon class="" icon="fa-user-shield" /> PERFIL TIPO ADMIN
        </div>
      </footer>
      <!-- FOOTER END-->
    </b-sidebar>
...
export default {
  name: "PanelAdmin",
  components: { Ticketera, Dashboard, Perfil, Cuentas },
  props: { user: String },
  data() {
    return {
      dashboard: true,
