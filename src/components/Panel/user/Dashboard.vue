...
<script>
import CardJoined from "./CardJoined.vue";
import CardInProgress from "./CardInProgress.vue";
import CardPaused from "./CardPaused.vue";
import CardCanceled from "./CardCanceled.vue";
import CardClosed from "./CardClosed.vue";
